...
CREATE TABLE "UserStrategy" (
    ...
    "riskPerTrade" REAL NOT NULL DEFAULT 0.01,
    "maxOpenPositions" INTEGER NOT NULL DEFAULT 1,
    "leverage" INTEGER NOT NULL DEFAULT 1,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "UserStrategy_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Bot" (
    ...
    "capital" REAL NOT NULL DEFAULT 500,
    "strategyKey" TEXT NOT NULL DEFAULT 'ADAPTIVE_FUSION',
