 ...
 * @returns {{firedByStrategy: string|null, slPrice: number|null, tpPrice: number|null, slMultiplier: number|null, tpMultiplier: number|null}}
 */
function buildTradeAttribution({ strategyKey, sl, tp, slDist, tpDist, atr }) {
  return {
