...
// v2.0: primary key is SMART_MONEY_CONCEPTS; ADAPTIVE_FUSION resolves via legacy alias
const afs = strategyRegistry.get("SMART_MONEY_CONCEPTS");
console.log(`✓ Loaded SMART_MONEY_CONCEPTS: ${afs ? "SUCCESS" : "FAILED"}`);
...
console.log(`✓ Legacy ADAPTIVE_FUSION alias → SMART_MONEY_CONCEPTS: ${legacyAf === afs ? "PASS" : "FAIL"}`);

const validation = strategyRegistry.validate("SMART_MONEY_CONCEPTS");
...
console.log("═".repeat(50));
console.log("✓ Registry: SMART_MONEY_CONCEPTS primary + legacy aliases resolved");
